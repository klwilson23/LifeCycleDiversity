...
results$portfolio <- 1/(results$mn_risk/results[results$age.structure=="Recent" & results$recCV=="Recent" & results$probGood==0.2 & results$probBad==0.8,"mn_risk"])
